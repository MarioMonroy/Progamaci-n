...
public class VtnEquilatero extends JFrame implements ActionListener{
	...
	private JLabel lbN1 = new JLabel("Ingresa el valor de la basé del Triángulo");
	private JTextField txtN2 = new JTextField();
	private JLabel lbN2 = new JLabel("Ingresa el valor de la altura del Triángulo");
...
public VtnEquilatero(){
		...
		super.setTitle("Perimetro Triángulo Equilátero");
	...
	public void actionPerformed(ActionEvent arg0) {
		 ...
		 */
		Float c = op.trianguloEquilatero(Float.parseFloat(txtN1.getText()), Float.parseFloat(txtN2.getText()));
		lbResultado.setText(String.format("(%s * %s) / 2 = %.2f",
				txtN1.getText(),
				txtN2.getText(),
				c));
