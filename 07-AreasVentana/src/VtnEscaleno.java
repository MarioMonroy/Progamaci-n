 ...
 *
 */
public class VtnEscaleno extends JFrame implements ActionListener{
...
public VtnEscaleno(){
	...
	public void actionPerformed(ActionEvent arg0) {
		 ...
		 */
		Float c = op.trianguloEscaleno(Float.parseFloat(txtN1.getText()), Float.parseFloat(txtN2.getText()), Float.parseFloat(txtN3.getText()));
		lbResultado.setText(String.format("(%s + %s + %s)/2 = %.2f",
				txtN1.getText(),
				txtN2.getText(),
				txtN3.getText(),
				c));
