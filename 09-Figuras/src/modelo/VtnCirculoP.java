 ...
 *
 */
public class VtnCirculoP extends JFrame implements ActionListener{
...
public VtnCirculoP(){
		...
		super.setTitle("Perimetro Círculo");
	...
	public void actionPerformed(ActionEvent arg0) {
		...
		Float cp = c.perimetro(0, 0, 0, 0, 0, 0, Float.parseFloat(txtN1.getText()));
