 ...
 *
 */
public class VtnRectanguloP extends JFrame implements ActionListener{
	 ...
	 */	
public VtnRectanguloP(){
		
		super.setTitle("Perimetro Rectángulo");
	...
	public void actionPerformed(ActionEvent arg0) {
		...
		Float r = re.perimetro(0, Float.parseFloat(txtN1.getText()), Float.parseFloat(txtN2.getText()), 0, 0, 0, 0);
		lbResultado.setText(String.format("2 * (%s + %s) = %.2f", txtN1.getText(), 
				txtN2.getText(), 
				r));
	}
